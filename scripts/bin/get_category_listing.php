...
class CategoryListing {
    ...
    protected static $ActionName        = 'CategoryListings';
    protected static $ResponseGroupName = 'Listings';
    ...
    protected static $SortBy            = 'Popularity';

    public function CategoryListing($accessKeyId, $secretAccessKey, $path, $start, $count) {
...
$categoryListing = new CategoryListing($accessKeyId, $secretAccessKey, $path, $start, $count);
$categoryListing->getCategoryListing();
